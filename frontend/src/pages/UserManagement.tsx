        ...
        <div className="p-6">
          <form className="space-y-4">
            ...
            <div>
              ...
              <input type="password" className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" />
            </div>

            <div className="flex items-center">
              <input type="checkbox" id="sendWelcomeEmail" className="mr-2" />
              <label htmlFor="sendWelcomeEmail" className="text-sm text-gray-700">Send welcome email with login instructions</label>
            </div>
          </form>
        </div>
        ...
        <div className="p-6 border-t bg-gray-50 flex space-x-3">
          ...
          <button
            onClick={() => {
              ...
              alert('User creation functionality will be implemented with backend integration');
              onClose();
            }}
