# PR003946-27 - Test Specification Analysis

## Ticket Information
- **Ticket**: PR003946-27
- **Summary**: GET /animal_config
- **Type**: Task
- **Status**: To Do
- **Test Category**: Integration

## Description
Get animal configuration. Purpose: implement GET /animal_config. Auth: Admin/Zoo Keeper (no auth required). Parameters: animalid (query, string, required). Request body: None. Responses: 200: Animal config (AnimalConfig). Queries DB for animal id and returns data structure 404/401 if not in correct group.  Only for Admin and Zoo Keeper…..
