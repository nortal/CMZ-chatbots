# PR003946-26 - Test Specification Analysis
...
## Description
Admin dashboard shell data. Purpose: implement GET /admin.
Auth: Requires bearerAuth.
Parameters: None.
Request body: None.
Responses: 200: Admin shell data/widgets (AdminShell). Identity check->just implement end point to be able to populate later.
