# PR003946-36 - Test Specification Analysis
...
## Description
Performance metrics between dates. Purpose: implement GET /performance_metrics.
Auth: Requires bearerAuth.
Parameters: start (query, string, required); end (query, string, required).
Request body: None.
Responses: 200: Metrics payload (PerformanceMetrics). Admin only. One container can serve multiple lambda endpoints Call getmetricdata
