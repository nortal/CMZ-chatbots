# PR003946-35 - Test Specification Analysis
...
## Description
User portal shell data. Purpose: implement GET /member. Auth: Requires bearerAuth. Parameters: userID  Request body: None. Responses: 200: Portal shell data/widgets (MemberShell). Future endpoint Able to use membership when not at Zoo
