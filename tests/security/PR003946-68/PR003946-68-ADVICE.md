# PR003946-68 - Test Specification Analysis

## Ticket Information
- **Ticket**: PR003946-68
- **Summary**: Auth required where declared
- **Type**: Task
- **Status**: In Progress
- **Test Category**: Security

## Description
As a client, I want endpoints that declare bearerAuth to return 401 without a token and 403 when role is insufficient. Scope/Endpoints:
All endpoints with security: bearerAuth (e.g., /userlist, /userrole, /feature_flags, /performance_metrics, /logs, /billing, /system_health, /family) Acceptance Criteria:
1) 401 when token missing/invalid. 2) 403 when authenticated but role is insufficient. 3) Document role matrix per endpoint.
