# PR003946-82 - Test Specification Analysis

## Ticket Information
- **Ticket**: PR003946-82
- **Summary**: Totals reflect applied filters
- **Type**: Task
- **Status**: To Do
- **Test Category**: Unit

## Description
As a client, I want total counts to reflect the current filter set. Scope/Endpoints:
/userlist, /logs (paged) Acceptance Criteria:
1) total equals count after applying filters (including soft-delete). 2) Document behavior.
