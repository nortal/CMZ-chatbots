# PR003946-19 - Test Specification Analysis

## Ticket Information
- **Ticket**: PR003946-19
- **Summary**: TASK: Generate dataclasses from OpenAPI
- **Type**: Task
- **Status**: Closed
- **Test Category**: Unit

## Description
Use datamodel-code-generator to emit @dataclass models from openapi/cmz-openapi.yaml to generated/cmz_models.py; never hand-edit. Add Makefile target and wire mappers to DB.
