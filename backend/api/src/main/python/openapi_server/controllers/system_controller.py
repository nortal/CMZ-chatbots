...
from openapi_server.models.chatgpt_health_get200_response import ChatgptHealthGet200Response  # noqa: E501
...
def chatgpt_health_get():  # noqa: E501
    """ChatGPT integration health check

     # noqa: E501


    :rtype: Union[ChatgptHealthGet200Response, Tuple[ChatgptHealthGet200Response, int], Tuple[ChatgptHealthGet200Response, int, Dict[str, str]]
    """
    ...
    try:
        ...
        error_obj = Error(
            ...
            message=f"Controller chatgpt_health_get implementation not found: {str(e)}",
            details={"controller": "SystemController", "operation": "chatgpt_health_get"}
        )
        ...
        try:
            ...
            error_obj = Error(
                code="internal_error",
                message=f"Internal server error in chatgpt_health_get: {str(e)}",
                details={"controller": "SystemController", "operation": "chatgpt_health_get"}
            )
